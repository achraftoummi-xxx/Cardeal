...
import { googleMapsUrl, partnerDistanceKm, type Partner } from "@/lib/partners";
                ...
                <Popup>
                  <div className="p-1">
                    ...
                    <a
                      ...
                      className="mt-1.5 flex w-full items-center justify-center gap-1.5 rounded-lg border border-blue-500/40 px-3 py-1.5 text-xs font-medium text-blue-500 transition-colors hover:bg-blue-500/10"
                    >
