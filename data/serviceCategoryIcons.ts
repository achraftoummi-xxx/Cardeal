...
const CATEGORY_ICONS: Record<string, string> = {
  ...
  "Peintures et carosserie": icon("spray-gun.png"),
...
const SUB_CATEGORY_ICONS: Record<string, string> = {
  ...
  "Polissage": icon("car-headlight_finish.png"),
  "Stickage": icon("spray-gun.png"),
  "Peinture complète et personnalisée": icon("car-painting.png"),
  "rénovation des optiques de phare": icon("car-lights_bulb.png"),
  "recharge climatiseur voiture": icon("ac_charge.png"),
  "réparation climatiseur voiture": icon("airconditionner.png"),
